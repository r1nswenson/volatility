...
// IOCTL
//
#define IOCTL_VIRTUAL_ADDRESS_IS_VALID CTL_CODE(FILE_DEVICE_UNKNOWN, 0x104, METHOD_BUFFERED, FILE_READ_DATA | FILE_WRITE_DATA)
...
typedef struct _VirtualAddressInfo {
  ULONG64 ProcessId;
